            ...
            <div className="relative flex flex-col h-full p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-900 shadow shadow-slate-950/5">
                {props.popular && (
                    <div className="absolute top-0 right-0 mr-6 -mt-4">
                        <div className="inline-flex items-center text-xs font-semibold py-1.5 px-3 bg-emerald-500 text-white rounded-full shadow-sm shadow-slate-950/5">Recommended</div>
                    </div>
                )}
                <div className="mb-5">
                    ...
                    <a className="w-full inline-flex justify-center whitespace-nowrap rounded-lg bg-blue-600 px-3.5 py-2.5 text-sm font-medium text-white shadow-sm shadow-indigo-950/10 hover:bg-indigo-600 focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 transition-colors duration-150" href="#0">
                        Purchase Plan
                    </a>
                </div>
    ...
    return (
        <div>
          ...
          <span className="absolute inset-0 m-1 pointer-events-none" aria-hidden="true">
            <span className={`absolute inset-0 w-1/2 bg-blue-600 rounded-full shadow-sm shadow-indigo-950/10 transform transition-transform duration-150 ease-in-out ${isAnnual ? 'translate-x-0' : 'translate-x-full'}`}></span>
          </span>
            ...
            <div className="max-w-sm mx-auto grid gap-6 lg:grid-cols-3 items-start lg:max-w-none">
                ...
                <PricingTab
                    ...
                    planDescription="Features of Trial Plan"
                    features={[
                ...
                <PricingTab
                    yearly={isAnnual}
                    planName="Pro"
                    price={{ yearly: 2.99, monthly: 3.99 }}
                    planDescription="Features of Pro"
                    features={[
                        ' AI-generated workout plans',
                        'Chat with AI Expert',
                    ]} />
                ...
                <PricingTab
                    ...
                    popular={true}
                    planName="Pro Max"
                    price={{ yearly: 3.99, monthly: 4.99 }}
                    planDescription="Features of Pro Max"
                    features={[
                        'AI-generated workout plans',
                        'Chat with AI Expert',
                        'Hide Ads',
